...
NPZ_PATH   = BASE_DIR / "calib_out" / "stereo_params_scaled.npz"
...
THRESH_MASK    = 0.7
ROW_TOL_Y      = 30
SELECTED_COLOR = "green"    # 예: 'orange' (None이면 콘솔 입력/엔터=전체), 원래는 None
SAVE_VIDEO     = False
OUT_FPS        = 30
OUT_PATH       = BASE_DIR / "videos" / "stereo_overlay.mp4"

CSV_GRIPS_PATH = BASE_DIR / "csv_folder" / "output_grips.csv"
TOUCH_THRESH = 10         
